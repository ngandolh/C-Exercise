namespace _1732_FindTheHighestAltitude
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //int result = largestAltitudeSolution.LargestAltitude(gain);
            //Console.WriteLine(
            ...
            //int result2 = largestAltitudeSolution.LargestAltitude(gain2);
            //Console.WriteLine(
            //    $"The highest altitude is {result2}");

            int[] gain3 = new int[] { 44, 32, -9, 52, 23, -50, 50, 33, -84, 47, -14, 84, 36, 
                -62, 37, 81, -36, -85, -39, 67, -63, 64, -47, 95, 91, -40, 65, 67, 92, -28, 97, 100, 81 };
            int result3 = largestAltitudeSolution.LargestAltitude(gain3);
            Console.WriteLine(
